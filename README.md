...
Overview:
  ...
  Bloom's Taxonomy is a framework used in education to categorize learning objectives by cognitive complexity. This project automates that classification using a transformer-based model fine-tuned on ~8,700 educational questions.
